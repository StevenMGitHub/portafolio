    ...
    <>
            <div class="" id='contact'>
                <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <p class="mb-8 lg:mb-16 font-light text-center text-gray-300 sm:text-xl">Got a technical issue? Want to send feedback about feature? Need details about my projects? Let me know.</p>
